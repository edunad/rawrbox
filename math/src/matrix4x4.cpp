...
namespace rawrbox {
	...
	void Matrix4x4::translate(const rawrbox::Vector3f& pos) {
		this->mtx[12] = pos.x;
		this->mtx[13] = pos.y;
		this->mtx[14] = pos.z;
	}

	void Matrix4x4::scale(const rawrbox::Vector3f& scale) {
		this->mtx[0] = scale.x;
		this->mtx[5] = scale.y;
		this->mtx[10] = scale.z;
	}

	void Matrix4x4::billboard(const rawrbox::Matrix4x4& view, const rawrbox::Vector3f& pos, const rawrbox::Vector3f& scale) {
	...
	void Matrix4x4::rotate(const rawrbox::Vector4f& rot) {
