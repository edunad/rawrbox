...
// https://github.com/simco50/D3D12_Research/blob/master/D3D12/Resources/Shaders/Packing.hlsli
...
float4 Unpack_BGRA8_UNORM(uint value) {
	uint4 packed = uint4(value & 0xff, (value >> 8) & 0xff, (value >> 16) & 0xff, value >> 24);
	return float4(packed.z, packed.y, packed.x, packed.w) / 255.0;
}

float4 Unpack_ARGB8_UNORM(uint value) {
	uint4 packed = uint4(value & 0xff, (value >> 8) & 0xff, (value >> 16) & 0xff, value >> 24);
