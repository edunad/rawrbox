...
namespace rawrbox {
	...
	protected:
		...
		void internalLoad(const uint8_t* buffer, int bufferSize, bool useFallback = true);
	...
	public:
		...
		explicit TextureWEBP(const std::filesystem::path& filePath, const uint8_t* buffer, int bufferSize, bool useFallback = true);
	};
} // namespace rawrbox
