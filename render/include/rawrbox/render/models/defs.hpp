...
namespace rawrbox {
	...
	struct VertexBoneData : public virtual VertexData {
		std::array<uint8_t, rawrbox::render::MAX_BONES_PER_VERTEX> bone_indices = {};
		std::array<float, rawrbox::render::MAX_BONES_PER_VERTEX> bone_weights = {};
		...
		static std::vector<Diligent::LayoutElement> vLayout(bool instanced = false) {
			std::vector<Diligent::LayoutElement> v = {
			    ...
			    Diligent::LayoutElement{3, 0, rawrbox::render::MAX_BONES_PER_VERTEX, Diligent::VT_UINT32, false},
			    // Attribute 4 - BONE-WEIGHTS
			    Diligent::LayoutElement{4, 0, rawrbox::render::MAX_BONES_PER_VERTEX, Diligent::VT_FLOAT32, false}};
	...
	struct VertexNormBoneData : public VertexNormData, public VertexBoneData {
		...
		static std::vector<Diligent::LayoutElement> vLayout(bool instanced = false) {
			std::vector<Diligent::LayoutElement> v = {
			    ...
			    Diligent::LayoutElement{5, 0, rawrbox::render::MAX_BONES_PER_VERTEX, Diligent::VT_UINT32, false},
			    // Attribute 6 - BONE-WEIGHTS
			    Diligent::LayoutElement{6, 0, rawrbox::render::MAX_BONES_PER_VERTEX, Diligent::VT_FLOAT32, false}};
