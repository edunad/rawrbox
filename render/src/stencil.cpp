...
namespace rawrBox {
	...
	void Stencil::pushVertice(rawrBox::Vector2 pos, const rawrBox::Vector2& uv, const rawrBox::Color& col) {
	...
	void Stencil::applyRotation(rawrBox::Vector2& vert) {
	...
	void Stencil::drawTexture(const rawrBox::Vector2& pos, const rawrBox::Vector2& size, std::shared_ptr<rawrBox::TextureBase> tex, rawrBox::Color col, rawrBox::Vector2 uvStart, rawrBox::Vector2 uvEnd) {
		// TextureImage setup -----
	...
	void Stencil::drawRecording() {
		...
		rawrBox::Vector2 size = this->_windowSize;
		rawrBox::Vector2 pos = {};
