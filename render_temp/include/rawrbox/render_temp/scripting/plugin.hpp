...
#include <rawrbox/render_temp/scripting/wrappers/decals_wrapper.hpp>
#include <rawrbox/render_temp/scripting/wrappers/light/base_wrapper.hpp>
#include <rawrbox/render_temp/scripting/wrappers/light/manager_wrapper.hpp>
#include <rawrbox/render_temp/scripting/wrappers/model/base_wrapper.hpp>
#include <rawrbox/render_temp/scripting/wrappers/model/instance_wrapper.hpp>
#include <rawrbox/render_temp/scripting/wrappers/model/instanced_wrapper.hpp>
#include <rawrbox/render_temp/scripting/wrappers/model/mesh_wrapper.hpp>
#include <rawrbox/render_temp/scripting/wrappers/model/model_wrapper.hpp>
#ifdef RAWRBOX_RESOURCES
	#include <rawrbox/render_temp/scripting/wrappers/resources/texture_loader_wrapper.hpp>
	#include <rawrbox/render_temp/scripting/wrappers/resources/font_loader_wrapper.hpp>
#endif
#include <rawrbox/render_temp/scripting/wrappers/stencil_wrapper.hpp>
...
#include <rawrbox/render_temp/scripting/wrappers/window_wrapper.hpp>
