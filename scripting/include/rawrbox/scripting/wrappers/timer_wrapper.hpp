...
namespace rawrbox {
	...
	public:
		...
		// CREATE ---
		virtual bool create(const std::string& id, int reps, float delay, sol::function callback, sol::optional<sol::function> onComplete);
		virtual bool simple(const std::string& id, float delay, sol::function callback, sol::optional<sol::function> onComplete);
		// ----
