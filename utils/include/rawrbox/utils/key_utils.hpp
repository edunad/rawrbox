	...
	class KeyUtils {
		...
		static std::string keyToStr(unsigned int key) {
			switch(key) {
				...
				case KEY_F12: return "F12"; // we don't use > F12
		...
		static unsigned int strToKey(const std::string& rawKey) {
			...
			else if(key == "'") return KEY_APOSTROPHE;
			else if(key == ",") return KEY_COMMA;
			else if(key == "-") return KEY_MINUS;
			else if(key == ".") return KEY_PERIOD;
			else if(key == "/") return KEY_SLASH;
			...
			else if(key == ";") return KEY_SEMICOLON;
			else if(key == "=") return KEY_EQUAL;

			else if(key == "A") return KEY_A;
			...
			else if(key == "[") return KEY_LEFT_BRACKET;
			else if(key == "\\") return KEY_BACKSLASH;
			else if(key == "]") return KEY_RIGHT_BRACKET;
			else if(key == "`") return KEY_GRAVE_ACCENT;

			else if(key == "ESCAPE") return KEY_ESCAPE;
			else if(key == "ENTER") return KEY_ENTER;
			...
			else if(key == "RIGHT") return KEY_RIGHT;
			else if(key == "LEFT") return KEY_LEFT;
			else if(key == "DOWN") return KEY_DOWN;
			else if(key == "UP") return KEY_UP;
			...
			else if(key == "PRINT_SCREEN") return KEY_PRINT_SCREEN;
			else if(key == "PAUSE") return KEY_PAUSE;
			...
			else if(key == "F12") return KEY_F12; // we don't use > F12
			...
			else if(key == "KP_DECIMAL") return KEY_KP_DECIMAL;
			else if(key == "KP_DIVIDE") return KEY_KP_DIVIDE;
			else if(key == "KP_MULTIPLY") return KEY_KP_MULTIPLY;
			else if(key == "KP_SUBTRACT") return KEY_KP_SUBTRACT;
			else if(key == "KP_ADD") return KEY_KP_ADD;
			else if(key == "KP_ENTER") return KEY_KP_ENTER;
			else if(key == "KP_EQUAL") return KEY_KP_EQUAL;

			else if(key == "LEFT_SHIFT") return KEY_LEFT_SHIFT;
			else if(key == "LEFT_CONTROL") return KEY_LEFT_CONTROL;
			else if(key == "LEFT_ALT") return KEY_LEFT_ALT;
			else if(key == "LEFT_SUPER") return KEY_LEFT_SUPER;

			else if(key == "RIGHT_SHIFT") return KEY_RIGHT_SHIFT;
			else if(key == "RIGHT_CONTROL") return KEY_RIGHT_CONTROL;
			else if(key == "RIGHT_ALT") return KEY_RIGHT_ALT;
			else if(key == "RIGHT_SUPER") return KEY_RIGHT_SUPER;
